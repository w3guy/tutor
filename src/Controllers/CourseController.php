...
class CourseController {
	 ...
	 * @return void
	 */
	public function show_courses_page() {
		/**
		 * Short able params
		 */
		...
		$navbar_data = array(
			...
			'tabs'         => $this->tabs_key_value( $category_slug, $course_id, $date, $search_filter ),
			'active'       => $active_tab,
			'add_button'   => true,
		...
		$filters = array(
			...
			'bulk_actions'    => $this->prepare_bulk_actions(),
		...
		include tutor()->path . 'views/pages/courses.php';
	}
