...
if ( ! function_exists( 'tutor' ) ) {
	...
	function tutor() {
		...
		$path        = plugin_dir_path( TUTOR_PLUGIN_FILE );
		...
		$info = array(
			'path'                 => $path,
			'url'                  => plugin_dir_url( TUTOR_PLUGIN_FILE ),
			'icon_dir'             => plugin_dir_url( TUTOR_PLUGIN_FILE ) . 'assets/images/images-v2/icons/',
			'v2_img_dir'           => plugin_dir_url( TUTOR_PLUGIN_FILE ) . 'assets/images/images-v2/',
			'current_url'          => $current_url,
			'basename'             => plugin_basename( TUTOR_PLUGIN_FILE ),
			'basepath'             => $base_path,
